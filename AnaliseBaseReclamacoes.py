...
wordcloud_estados = WordCloud(background_color='black', collocations=False, colormap='GnBu', width=3000, height=2000,max_font_size=1000, max_words=40).generate(s_estados)
plt.figure(figsize=(40,30), facecolor='k', edgecolor='k')
